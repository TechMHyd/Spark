...
public class UBIUtils {
	...
	private static Logger logger = LoggerFactory.getLogger("UBIUtils");
	...
	private static final String PERSIST_DATA = "PERSIST_DATA";
	private static final String DEFAULT_PERSIST_DATA = "Y";
	...
	public static String getPERSIST_DATA() {
		return getValue(props.getProperty(PERSIST_DATA),DEFAULT_PERSIST_DATA);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(getPERSIST_DATA());
	}
